...
class Utils
{
    public static function renderTpl($tpl, array $vars = [])
    {
        ob_start();
    ...
    public static function sanitize($str, $lower = true)
    {
        if (extension_loaded('intl')) {
            $new = preg_replace('/\s+/', '-', \Transliterator::createFromRules(':: NFD; :: [:Nonspacing Mark:] Remove; :: Lower(); :: NFC;', \Transliterator::FORWARD)->transliterate($str));
        } else {
            $map = [
                'ъ' => '-', 'ь' => '-', 'Ъ' => '-', 'Ь' => '-',
        ...
        return true === $lower ? strtolower($new) : $new;
    }
}
