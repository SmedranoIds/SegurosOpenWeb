...
function get_breadcrumb() {
  ...
  if (is_home() || is_front_page()) {
    ...
    if ( is_category() ) {
      ...
      echo $before . 'Archivar por categor&iacute;a "' . single_cat_title('', false) . '"' . $after;
 
    } elseif ( is_search() ) {
      echo $before . 'Resultados de b&uacute;squeda para "' . get_search_query() . '"' . $after;
      ...
      echo $before . 'Publicaciones etiquetadas "' . single_tag_title('', false) . '"' . $after;
 
    } elseif ( is_author() ) {
       global $author;
      $userdata = get_userdata($author);
      echo $before . 'Art&iacute;culos publicados por ' . $userdata->display_name . $after;
