				...
				<div style="text-align: center; padding-bottom: 15px;">
					...
					<?php if ( get_sub_field('url_icono_ext')): ?>
                     <!-- Si la url es externa, que enlace acepte y use el link externo -->
                        <a href="<?php the_sub_field('url_icono_ext'); ?>" target="<?php the_sub_field('target_icono'); ?>"><img style="width: 120px;" src="<?php the_sub_field('icono_sec'); ?>"></a>
                    <?php else :?>
                    <!-- Si no lo es, que muestre un enlace normal interno -->
                        <a href="<?php the_sub_field('url_icono'); ?>" target="<?php the_sub_field('target_icono'); ?>"><img style="width: 120px;" src="<?php the_sub_field('icono_sec'); ?>"></a>
                    <?php endif ;?>
